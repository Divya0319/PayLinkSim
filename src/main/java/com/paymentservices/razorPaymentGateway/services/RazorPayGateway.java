...
public class RazorPayGateway implements PaymentGateway {
    ...
    public String createPaymentLink(PaymentLinkRequestDto paymentLinkRequestDto) {
        ...
        */
        ...
        customer.put("email","divygupta0319@gmail.com");
        paymentLinkRequest.put("customer",customer);

        JSONObject notes = new JSONObject();
        notes.put("policy_name","Jeevan Bima");
        paymentLinkRequest.put("notes",notes);
        paymentLinkRequest.put("callback_url","http://razorpay-payment-gateway-env.eba-vqinp3hj.us-east-2.elasticbeanstalk.com/payment/paymentCallback");
